...
def fetch_top_characters(limit=10):
...
def dataStuff():
    ...
    with chat_col:
        ...
        user_msg = st.text_area("Ask me a question Why don'tya:", height=100, placeholder="e.g., Who appears in more episodes, and why?")
